...
private val DarkColors = darkColorScheme(
    ...
    surfaceContainerLowest = DarkOcColors.bg,
    surfaceContainerLow = DarkOcColors.surface,
    surfaceContainer = DarkOcColors.surface,
    surfaceContainerHigh = DarkOcColors.surfaceVariant,
    surfaceContainerHighest = DarkOcColors.surfaceVariant,
    surfaceDim = DarkOcColors.bg,
    surfaceBright = DarkOcColors.surfaceVariant,
    inverseSurface = DarkOcColors.textPrimary,
    inverseOnSurface = DarkOcColors.bg,
    error = DarkOcColors.red,
    onError = DarkOcColors.bg,
    errorContainer = DarkOcColors.redBg,
    onErrorContainer = DarkOcColors.red,
    outline = DarkOcColors.border,
    outlineVariant = DarkOcColors.border,
    scrim = androidx.compose.ui.graphics.Color.Black,
    surfaceTint = DarkOcColors.primary,
)
...
private val LightColors = lightColorScheme(
    ...
    surfaceContainerLowest = LightOcColors.bg,
    surfaceContainerLow = LightOcColors.surface,
    surfaceContainer = LightOcColors.surface,
    surfaceContainerHigh = LightOcColors.surfaceVariant,
    surfaceContainerHighest = LightOcColors.surfaceVariant,
    surfaceDim = LightOcColors.surfaceVariant,
    surfaceBright = LightOcColors.bg,
    inverseSurface = LightOcColors.textPrimary,
    inverseOnSurface = LightOcColors.bg,
    error = LightOcColors.red,
    onError = LightOcColors.bg,
    errorContainer = LightOcColors.redBg,
    onErrorContainer = LightOcColors.red,
    outline = LightOcColors.border,
    outlineVariant = LightOcColors.border,
    scrim = androidx.compose.ui.graphics.Color.Black,
    surfaceTint = LightOcColors.primary,
)
